CreateThread(function()
    ...
    local give_weapon_list = {

        {
            ...
            Weapons = {"WEAPON_KNIFE", "WEAPON_KNUCKLE", "WEAPON_NIGHTSTICK", "WEAPON_HAMMER", "WEAPON_BAT", "WEAPON_GOLFCLUB", "WEAPON_CROWBAR", "WEAPON_BOTTLE", "WEAPON_DAGGER", "WEAPON_HATCHET", "WEAPON_MACHETE", "WEAPON_FLASHLIGHT", "WEAPON_SWITCHBLADE", "WEAPON_FLARE", "WEAPON_SMOKEGRENADE", "WEAPON_GRENADE", "WEAPON_MOLOTOV", "WEAPON_SNOWBALL"}
...

        {
            ...
            Weapons = {"WEAPON_RAYPISTOL", "WEAPON_PISTOL", "WEAPON_COMBATPISTOL", "WEAPON_APPISTOL", "WEAPON_PISTOL50", "WEAPON_SNSPISTOL", "WEAPON_HEAVYPISTOL", "WEAPON_VINTAGEPISTOL", "WEAPON_STUNGUN", "WEAPON_FLAREGUN", "WEAPON_MARKSMANPISTOL", "WEAPON_REVOLVER", "WEAPON_MACHINEPISTOL"}
...

        {
            ...
            Weapons = {"WEAPON_SMG", "WEAPON_MINISMG", "WEAPON_ASSAULTSMG", "WEAPON_MICROSMG", "WEAPON_COMBATPDW"}
...

        {
            ...
            Weapons = {"WEAPON_MG", "WEAPON_COMBATMG", "WEAPON_GUSENBERG", "WEAPON_ASSAULTSMG", "WEAPON_ASSAULTRIFLE", "WEAPON_CARBINERIFLE", "WEAPON_ADVANCEDRIFLE", "WEAPON_SPECIALCARBINE", "WEAPON_BULLPUPRIFLE", "WEAPON_COMPACTRIFLE"}
...

        {
            ...
            Weapons = {"WEAPON_SNIPERRIFLE", "WEAPON_HEAVYSNIPER", "WEAPON_MARKSMANRIFLE"}
...

        {
            ...
            Weapons = {"WEAPON_GRENADELAUNCHER", "WEAPON_GRENADELAUNCHER_SMOKE", "WEAPON_HOMINGLAUNCHER", "WEAPON_FIREWORK", "WEAPON_STINGER"}
...

        {
            ...
            Weapons = {"WEAPON_PISTOL_MK2", "WEAPON_SMG_MK2", "WEAPON_COMBATMG_MK2", "WEAPON_ASSAULTRIFLE_MK2", "WEAPON_CARBINERIFLE_MK2", "WEAPON_HEAVYSNIPER_MK2"}
        },

        {
            ...
            Weapons = {"WEAPON_RAILGUN", "WEAPON_RPG", "WEAPON_BALL", "WEAPON_FIREEXTINGUISHER", "WEAPON_PETROLCAN", "WEAPON_STICKYBOMB", "WEAPON_MUSKET"}
        }
    ...
    local Sonidos = {'Buldozer', 'End call', 'Beep', 'Beep2', 'Beep3', 'Beep4', 'Beep5', 'Power down', 'Explode', 'DiggerRevOneShot', 'Hang_Up', 'PIN_BUTTON', 'Crash', 'Beep_Green', 'Power_Down', '3_2_1', 'ATM_WINDOW', 'Boss_Blipped' 'BulldozerDefault', 'Phone_SoundSet_Michael', 'ATM_SOUNDS', 'DLC_HEIST_HACKING_SNAKE_SOUNDS', 'DLC_HEIST_HACKING_SNAKE_SOUNDS', 'DLC_HEIST_HACKING_SNAKE_SOUNDS', 'HUD_MINI_GAME_SOUNDSET', 'HUD_FRONTEND_DEFAULT_SOUNDSET', 'GTAO_Magnate_Hunt_Boss_SoundSet'}

    local SonidosE = {'Checkpoint_Hit', 'GTAO_FM_Events_Soundset', 'Boss_Blipped', 'GTAO_Magnate_Hunt_Boss_SoundSet', 'Bomb_Disarmed', 'GTAO_Speed_Convoy_Soundset', 'All', 'SHORT_PLAYER_SWITCH_SOUND_SET', 'SELECT', 'HUD_MINI_GAME_SOUNDSET'}
    ...
    PCCT:AddCategory("Tu Mismo", function(self, x, y, w, h)
        ...
        if self.DynamicTriggers["esx_ambulancejob"] and self.DynamicTriggers["esx_ambulancejob"]["esx_ambulancejob:revive"] then
            ...
            if self.Painter:Button("REVIVIR ~g~ESX", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "esx_revive") then
        ...
        if self.DynamicTriggers["esx_basicneeds"] and self.DynamicTriggers["esx_basicneeds"]["esx_basicneeds:healPlayer"] then
            ...
            local _w = (self.Painter:GetTextWidth("Dar Comidas ~g~ESX", 4, 0.37)) + 2



            if self.Painter:Button("Curarse ~g~ESX", x, y, w - _w, curY, nil, 20, 255, 255, 255, 255, "refill_needs") then

                PCCT:GetFunction("TriggerEvent")(self.DynamicTriggers["esx_basicneeds"]["esx_basicneeds:healPlayer"])

                PCCT:AddNotification("EXITO", "Ahora tienes vida!")
    ...
    PCCT:AddCategory("Destroyer (~r~RIESGO~w~)", function(self, x, y, w, h)
        ...
        if self.Painter:CheckBox("EARRAPE SERVER(~b~NO USAR~w~)", _use_earrape_loop, x, y, 5, curY, nil, 20, 255, 255, 255, 255, "_use_earrape_loop") then
            ...
            if self.Config.SafeMode then
                ...
                if _use_earrape_loop then
                    ...
                    self:AddNotification("INFO", "Usando earrape!", 10000)

                else

                    self:AddNotification("INFO", "Intentando parar.", 10000)
    ...
    PCCT:AddCategory("Triggers(~b~TEST~w~)", function(self, x, y, w, h)
        ...
        if resource_list["esx_gopostaljob"] then

            if self.Painter:Button("GOPOSTAL ~g~ESX ($$$)", x, y, 5, curY, nil, 20, 255, 255, 255, 255, "esx_gopostaljob") then

                for i = 1, 20 do

                    self:GetFunction("TriggerServerEvent")("gopostal:cash", 100)
