...
local planes = {'cuban800','titan','duster','luxor','Stunt','mammatus','velum','Shamal','Lazer','vestra','volatol','besra','dodo','alkonost','velum2','hydra','luxor2','nimbus','howard','alphaz1','seabreeze','nokota','molotok','starling','tula','microlight','rogue','pyro','mogul','strikeforce','avenger','avenger2','bombushka','volatol'}
local coords = {
...
menu.action(menu.my_root(), "Crash Cam Off", {}, "", function()
...
menu.action(menu.my_root(), "Clear Area", {"cleanse"}, "", function()
