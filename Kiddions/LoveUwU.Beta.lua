...
WepCD = menu:add_submenu("Extras De Armaz")
...
function CCooldown(e) if not localplayer then return end if e then globals.set_int(277753, 0) globals.set_int(277754, 0) else globals.set_int(277753, 300000) globals.set_int(277754, 1800000) end end ccMenu:add_toggle("Remover CulDouns", function() return e13 end, function() e13 = not e13 CCooldown(e13) end)
...
function NCooldown(e) if not localplayer then return end if e then globals.set_int(286620, 0) else globals.set_int(286620, 300000) end end ncMenu:add_toggle("Remover culdouns", function() return e14 end, function() e14 = not e14 NCooldown(e14) end)
...
function tonyC(e) if not localplayer then return end if e then globals.set_float(286669, 0) else globals.set_float(286669, 0.1) end end ncMenu:add_toggle("Remover iva de tony", function() return e29 end, function() e29 = not e29 tonyC(e29) end) ncMenu:add_action("-------Testeado:solo public; ~Max=4M------------", function() end)
...
function VRC(e) if not localplayer then return end if e then globals.set_int(281143, 1000) else globals.set_int(281143, 1000) end end mcMenu:add_toggle("Remover costo de suministroz", function() return e22 end, function() e22 = not e22 VRC(e22) end)
function MCrr(e) if not localplayer then return end if e then for i = 0, 4 do stats.set_int(mpx.."PAYRESUPPLYTIMER"..i, 1) sleep(0.1) end else for i = 0, 4 do stats.set_int(mpx.."PAYRESUPPLYTIMER"..i, 0) end end end mcMenu:add_toggle("Reienar suminiztroz(beta)", function() return e25 end, function() e25 = not e25 MCrr(e25) end)
function MCgs(e) if not localplayer then return end if e then globals.set_int(280439, 0) else globals.set_int(280439, 40000) end end mcMenu:add_toggle("Remover senial global", function() return e24 end, function() e24 = not e24 MCgs(e24) end)
...
local function ronC(e) if not localplayer then return end if e then globals.set_float(284966, 0) else globals.set_float(284966, 0.025) end end mmHmenu:add_toggle("Remove Rons's cut", function() return e30 end, function() e30 = not e30 ronC(e30) end)
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local pedlMenu = dinMenu:add_submenu("Lup De Pedz$$$")
pedlMenu:add_action("Dinero De Pedz [60k/10 Min]", PedDrop)	
pedlMenu:add_action("Skills Max", function()
	mpIndex = globals.get_int(1574907)
	if mpIndex == 0 then
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local CREDMenu = mainMenu:add_submenu("Creditos") CREDMenu:add_action("Kiddions ", function() end) CREDMenu:add_action("XxpichoclesxX>Coder", function() end) CREDMenu:add_action("EmirPrime>Tester ", function() end) CREDMenu:add_action("Pepe>Dominican-Boi", function() end) CREDMenu:add_action("Ady>Tester", function() end) CREDMenu:add_action("Sammy>Tester", function() end)