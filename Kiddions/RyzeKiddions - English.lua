...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
appMenu:add_array_item("Set A Delay", {"1", "2", "3", "4", "5", "6", "7", "8"}, function() return xox_31 end, function(value) xox_31 = value if value == 1 then duFF = 0.01 elseif value == 2 then duFF = 0.05 elseif value == 3 then duFF = 0.08 elseif value == 4 then duFF = 0.1 elseif value == 5 then duFF = 0.15 elseif value == 6 then duFF = 0.2 elseif value == 7 then duFF = 0.25 else duFF = 0.3 end end) appMenu:add_action("---", function() end)
appMenu:add_array_item("Normal Skin", PedSelf, function() return self_hash end, function(value) self_hash = value globals.set_int(2671449+59, 1) globals.set_int(2671449+46, value) sleep(duFF) globals.set_int(2671449+59, 0) end)
appMenu:add_array_item("Animals", PedModelAnimal, function() return animal_hash end, function(value) animal_hash = value globals.set_int(2671449+59, 1) globals.set_int(2671449+46, value) sleep(duFF) globals.set_int(2671449+59, 0) end)
...
appMenu:add_array_item("Birds", PedModelBird, function() return bird_hash end, function(value) bird_hash = value globals.set_int(2671449+59, 1) globals.set_int(2671449+46, value) sleep(duFF) globals.set_int(2671449+59, 0) end)
appMenu:add_array_item("Sea Animals", PedModelSeaAnimal, function() return sea_hash end, function(value) sea_hash = value globals.set_int(2671449+59, 1) globals.set_int(2671449+46, value) sleep(duFF) globals.set_int(2671449+59, 0) end)
appMenu:add_action("Be Bigfoot", function()	globals.set_int(2671449+59, 1) globals.set_int(2671449+46, -1389097126) sleep(duFF) globals.set_int(2671449+59, 0) end)
appMenu:add_action("---[Change Delay If Not Work]---", function() end)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
--ANM = {}
...
--end)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local repMenu = modelMenu:add_submenu("See Reports")
...
repMenu:add_bare_item("", function() return "Bad Talking:".. (string.format("%03d", stats.get_int("MPPLY_TC_HATE"))) end, function() end, function()end, function()end)
repMenu:add_bare_item("", function() return "Bad Talking 2:".. (string.format("%03d", stats.get_int("MPPLY_VC_ANNOYINGME"))) end, function() end, function()end, function()end)
repMenu:add_bare_item("", function() return "Bad Talking 3:".. (string.format("%03d", stats.get_int("MPPLY_VC_HATE"))) end, function() end, function()end, function()end)
...
repMenu:add_bare_item("", function() return "Offensive ID:".. (string.format("%03d", stats.get_int("MPPLY_OFFENSIVE_TAGPLATE"))) end, function() end, function()end, function()end)
...
repMenu:add_bare_item("", function() return "Bad Crew Logo:".. (string.format("%03d", stats.get_int("MPPLY_BAD_CREW_EMBLEM"))) end, function() end, function()end, function()end)
...
OnlMenu:add_toggle("Fast TP(NumDel)", function()
	return enable2
end, function()
	enable2 = not enable2
	TPHkS(enable2)
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
OnlMenu:add_action("Habilities 100%", function()
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local WepMenu = mainMenu:add_submenu("Weapons")
...
WepMenu:add_action("Stone Axe",function()
...
OnlMenu:add_toggle("Undead Off Radar", GetUndeadOffradar, SetUndeadOffradar)
...
OnlMenu:add_int_range("RP (Correction)", 1, 0, 8000, function()
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
OnlMenu:add_action("Bypass Orbital Canon Delay", function()
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local statMenu = OnlMenu:add_submenu("Stat Editor")
statMenu:add_float_range("Mental State", 1.0, 0.0, 100, function() return stats.get_float("MPPLY_PLAYER_MENTAL_STATE") end, function(value) stats.set_float(mpx .. "PLAYER_MENTAL_STATE", value) stats.set_float("MPPLY_PLAYER_MENTAL_STATE", value) end)
statMenu:add_int_range("Total Earned Money", 500000, 0, 1000000000, function() return stats.get_int("MPPLY_TOTAL_EVC") end, function(value) stats.set_int("MPPLY_TOTAL_EVC",value) end)
statMenu:add_int_range("Total Spended Money", 500000, 0, 1000000000, function() return stats.get_int("MPPLY_TOTAL_SVC") end, function(value) stats.set_int("MPPLY_TOTAL_SVC",value) end)
statMenu:add_int_range("Players Killed", 10, 0, 999999, function() return stats.get_int("MPPLY_KILLS_PLAYERS") end, function(value) stats.set_int("MPPLY_KILLS_PLAYERS", value) end)
statMenu:add_int_range("Times Died", 10, 0, 999999, function() return stats.get_int("MPPLY_DEATHS_PLAYER") end, function(value) stats.set_int("MPPLY_DEATHS_PLAYER", value) end)
statMenu:add_float_range("K/D Ratio", 0.01, 0, 9999, function() return stats.get_float("MPPLY_KILL_DEATH_RATIO") end, function(value) stats.set_float("MPPLY_KILL_DEATH_RATIO", value) end)
statMenu:add_int_range("Published DeathMatches", 10, 0, 999999, function() return stats.get_int("MPPLY_AWD_FM_CR_DM_MADE") end, function(value) stats.set_int("MPPLY_AWD_FM_CR_DM_MADE", value) end)
statMenu:add_int_range("Published Races", 10, 0, 999999, function() return stats.get_int("MPPLY_AWD_FM_CR_RACES_MADE") end, function(value) stats.set_int("MPPLY_AWD_FM_CR_RACES_MADE", value) end)
statMenu:add_int_range("Published Captures", 10, 0, 999999, function() return stats.get_int("MPPLY_NUM_CAPTURES_CREATED") end, function(value) stats.set_int("MPPLY_NUM_CAPTURES_CREATED", value) end)
statMenu:add_int_range("Published LTS", 10, 0, 999999, function() return stats.get_int("MPPLY_LTS_CREATED") end, function(value) stats.set_int("MPPLY_LTS_CREATED", value) end)
statMenu:add_int_range("Persons Who Had Played Ur M", 10, 0, 999999, function() return stats.get_int("MPPLY_AWD_FM_CR_PLAYED_BY_PEEP") end, function(value) stats.set_int("MPPLY_AWD_FM_CR_PLAYED_BY_PEEP", value) end)
statMenu:add_int_range("Likes To Ur Content", 10, 0, 999999, function() return stats.get_int("MPPLY_AWD_FM_CR_MISSION_SCORE") end, function(value) stats.set_int("MPPLY_AWD_FM_CR_MISSION_SCORE", value) end)
statMenu:add_int_range("Restart LSM (Not Unlocking)", 1, 1, 11, function() return 0 end, function(V) if V == 1 then vt = 5 elseif V == 2 then vt = 415 elseif V == 3 then vt = 1040 elseif V == 4 then vt = 3665 elseif V == 5 then vt = 10540 elseif V == 6 then vt = 20540 elseif V == 7 then vt = 33665 elseif V == 8 then vt = 49915 elseif V == 9 then vt = 69290 elseif V == 10 then vt = 91790 else vt = 117430 end stats.set_int(mpx .. "CAR_CLUB_REP", vt) end) statMenu:add_action("~[1/5/10/25/50/75/100/125/150/175/200]", function() end) statMenu:add_action("-{Change Session To Take Efect}", function() end)
statMenu:add_action("-----------------------------------------", function() end)
statMenu:add_int_range("Remove Money", 1000000, 1000000, 2000000000, function() return globals.get_int(282478) end, function(value) globals.set_int(282478, value) end) statMenu:add_action("Set the value then buy ballistic armour", function() end)
statMenu:add_action("-----------------------------------------", function() end)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local distMenu = OnlMenu:add_submenu("Distance Stats")
distMenu:add_float_range("Traveled(metters)", 10.00, 0.00, 99999.00, function() return stats.get_float("MPPLY_CHAR_DIST_TRAVELLED")/1000 end, function(value) stats.set_float("MPPLY_CHAR_DIST_TRAVELLED", value*1000) end)
distMenu:add_float_range("Swiming", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."DIST_SWIMMING")/1000 end, function(value) stats.set_float(mpx.."DIST_SWIMMING", value*1000) end)
distMenu:add_float_range("Walking", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."DIST_WALKING")/1000 end, function(value) stats.set_float(mpx.."DIST_WALKING", value*1000) end)
distMenu:add_float_range("Runing", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."DIST_RUNNING")/1000 end, function(value) stats.set_float(mpx.."DIST_RUNNING", value*1000) end)
distMenu:add_float_range("Longest Free Fall", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."LONGEST_SURVIVED_FREEFALL") end, function(value) stats.set_float(mpx.."LONGEST_SURVIVED_FREEFALL", value) end)
...
distMenu:add_float_range("Driving Motorbycles", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."DIST_BIKE")/1000 end, function(value) stats.set_float(mpx.."DIST_BIKE", value*1000) end)
...
distMenu:add_float_range("Driving Boats", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."DIST_BOAT")/1000 end, function(value) stats.set_float(mpx.."DIST_BOAT", value*1000) end)
distMenu:add_float_range("Driving ATV's", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."DIST_QUADBIKE")/1000 end, function(value) stats.set_float(mpx.."DIST_QUADBIKE", value*1000) end)
distMenu:add_float_range("Driving Bicycles", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."DIST_BICYCLE")/1000 end, function(value) stats.set_float(mpx.."DIST_BICYCLE", value*1000) end)
distMenu:add_float_range("Longest Stop", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."LONGEST_STOPPIE_DIST")/1000 end, function(value) stats.set_float(mpx.."LONGEST_STOPPIE_DIST", value*1000) end)
distMenu:add_float_range("Longest 1 weelie", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."LONGEST_WHEELIE_DIST")/1000 end, function(value) stats.set_float(mpx.."LONGEST_WHEELIE_DIST", value*1000) end)
distMenu:add_float_range("Longest Driving W/Crashing", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."LONGEST_DRIVE_NOCRASH")/1000 end, function(value) stats.set_float(mpx.."LONGEST_DRIVE_NOCRASH", value*1000) end)
distMenu:add_float_range("Longest Jump In Car", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."FARTHEST_JUMP_DIST") end, function(value) stats.set_float(mpx.."FARTHEST_JUMP_DIST", value) end)
distMenu:add_float_range("Highest Jump In Car", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."HIGHEST_JUMP_REACHED") end, function(value) stats.set_float(mpx.."HIGHEST_JUMP_REACHED", value) end)
distMenu:add_float_range("Highest Hidraulic Jump", 10.00, 0.00, 99999.00, function() return stats.get_float(mpx.."LOW_HYDRAULIC_JUMP") end, function(value) stats.set_float(mpx.."LOW_HYDRAULIC_JUMP", value) end)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local timeMenu = OnlMenu:add_submenu("Time Stats (Days)")
timeMenu:add_int_range("Time In FP", 1, 0, 24, function() return math.floor(stats.get_int("MP_FIRST_PERSON_CAM_TIME")/86400000) end, function(value) stats.set_int("MP_FIRST_PERSON_CAM_TIME", value*86400000) end)
timeMenu:add_int_range("Time In Gta Online", 1, 0, 24, function() return math.floor(stats.get_int("MP_PLAYING_TIME")/86400000) end, function(value) stats.set_int("MP_PLAYING_TIME", value*86400000) end)
timeMenu:add_int_range("Time In DeathMatches", 1, 0, 24, function() return math.floor(stats.get_int("MPPLY_TOTAL_TIME_SPENT_DEATHMAT")/86400000) end, function(value) stats.set_int("MPPLY_TOTAL_TIME_SPENT_DEATHMAT", value*86400000) end)
timeMenu:add_int_range("Time In Races", 1, 0, 24, function() return math.floor(stats.get_int("MPPLY_TOTAL_TIME_SPENT_RACES")/86400000) end, function(value) stats.set_int("MPPLY_TOTAL_TIME_SPENT_RACES", value*86400000) end)
timeMenu:add_int_range("Time In Creator Mode", 1, 0, 24, function() return math.floor(stats.get_int("MPPLY_TOTAL_TIME_MISSION_CREATO")/86400000) end, function(value) stats.set_int("MPPLY_TOTAL_TIME_MISSION_CREATO", value*86400000) end)
timeMenu:add_int_range("Longest Alone Session", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."LONGEST_PLAYING_TIME")/86400000) end, function(value) stats.set_int(mpx.."LONGEST_PLAYING_TIME", value*86400000) end)
timeMenu:add_int_range("Time Has Character", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TOTAL_PLAYING_TIME")/86400000) end, function(value) stats.set_int(mpx.."TOTAL_PLAYING_TIME", value*86400000) end)
timeMenu:add_int_range("Average Time Sin Sessions", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."AVERAGE_TIME_PER_SESSON")/86400000) end, function(value) stats.set_int(mpx.."AVERAGE_TIME_PER_SESSON", value*86400000) end)
timeMenu:add_int_range("Time Swiming", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TIME_SWIMMING")/86400000) end, function(value) stats.set_int(mpx.."TIME_SWIMMING", value*86400000) end)
timeMenu:add_int_range("Time Under Water", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TIME_UNDERWATER")/86400000) end, function(value) stats.set_int(mpx.."TIME_UNDERWATER", value*86400000) end)
...
timeMenu:add_int_range("Time In Wall", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TIME_IN_COVER")/86400000) end, function(value) stats.set_int(mpx.."TIME_IN_COVER", value*86400000) end)
timeMenu:add_int_range("Time With Police", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TOTAL_CHASE_TIME")/86400000) end, function(value) stats.set_int(mpx.."TOTAL_CHASE_TIME", value*86400000) end)
...
timeMenu:add_float_range("5 Stars", 1.0, 0.0, 24.0, function() return math.floor(stats.get_float(mpx.."TOTAL_TIME_MAX_STARS")/86400000) end, function(value) stats.set_float(mpx.."TOTAL_TIME_MAX_STARS", value*86400000) end)
timeMenu:add_action("More Time Functions", function() end)
...
timeMenu:add_int_range("In MotorCycle", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TIME_DRIVING_BIKE")/86400000) end, function(value) stats.set_int(mpx.."TIME_DRIVING_BIKE", value*86400000) end)
timeMenu:add_int_range("In Helicopters", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TIME_DRIVING_HELI")/86400000) end, function(value) stats.set_int(mpx.."TIME_DRIVING_HELI", value*86400000) end)
timeMenu:add_int_range("In Airplanes", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TIME_DRIVING_PLANE")/86400000) end, function(value) stats.set_int(mpx.."TIME_DRIVING_PLANE", value*86400000) end)
timeMenu:add_int_range("In Boats", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TIME_DRIVING_BOAT")/86400000) end, function(value) stats.set_int(mpx.."TIME_DRIVING_BOAT", value*86400000) end)
timeMenu:add_int_range("Driving ATVs", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TIME_DRIVING_QUADBIKE")/86400000) end, function(value) stats.set_int(mpx.."TIME_DRIVING_QUADBIKE", value*86400000) end)
timeMenu:add_int_range("In Bicycles", 1, 0, 24, function() return math.floor(stats.get_int(mpx.."TIME_DRIVING_BICYCLE")/86400000) end, function(value) stats.set_int(mpx.."TIME_DRIVING_BICYCLE", value*86400000) end)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local heistMenu = OnlMenu:add_submenu("Heist")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
cayoPericoMenu:add_array_item("Principall Objectives", {"Tequila", "Ruby Necklace", "Bearer Bonds", "Pink Diamond", "Panther Statue"}, function() return xox_0 end, function(value) xox_0 = value if value == 1 then stats.set_int(mpx .. "H4CNF_TARGET", 0) elseif value == 2 then stats.set_int(mpx .. "H4CNF_TARGET", 1) elseif value == 3 then stats.set_int(mpx .. "H4CNF_TARGET", 2) elseif value == 4 then stats.set_int(mpx .. "H4CNF_TARGET", 3) elseif value == 5 then stats.set_int(mpx .. "H4CNF_TARGET", 5) end end)
local StMenu = cayoPericoMenu:add_submenu("Secundary Objectives") StMenu:add_array_item("All Compound Storages", {"Gold", "Paintings", "Cocaine", "Weed", "Cash"}, function() return xox_1 end, function(value) if value == 1 then stats.set_int(mpx .. "H4LOOT_GOLD_C", -1) stats.set_int(mpx .. "H4LOOT_GOLD_C_SCOPED", -1) elseif value == 2 then stats.set_int(mpx .. "H4LOOT_PAINT", -1) stats.set_int(mpx .. "H4LOOT_PAINT_SCOPED", -1) stats.set_int(mpx .. "H4LOOT_PAINT_V", 403500) elseif value == 3 then stats.set_int(mpx .. "H4LOOT_COKE_C", -1) stats.set_int(mpx .. "H4LOOT_COKE_C_SCOPED", -1) elseif value == 4 then stats.set_int(mpx .. "H4LOOT_WEED_C", -1) stats.set_int(mpx .. "H4LOOT_WEED_C_SCOPED", -1) elseif value == 5 then stats.set_int(mpx .. "H4LOOT_CASH_C", -1) stats.set_int(mpx .. "H4LOOT_CASH_C_SCOPED", -1) end xox_1 = value end)
cayoPericoMenu:add_action("All Preps", function() stats.set_int(mpx .. "H4CNF_BS_GEN", -1) stats.set_int(mpx .. "H4CNF_BS_ENTR", 63) stats.set_int(mpx .. "H4CNF_APPROACH", -1) end) cayoPericoMenu:add_action("---", function() end)
cayoPericoMenu:add_toggle("Remove Cameras", function() return e6 end, function() e6 = not e6 Cctv(e6) end) cayoPericoMenu:add_action("Skip Dreinage Cutscene", function() if fmC2020:is_active() then if fmC2020:get_int(27500) >= 3 or fmC2020:get_int(27500) <= 6 then fmC2020:set_int(27500, 6) end end end) cayoPericoMenu:add_action("Bypass FingerPrints ", function() if fmC2020 and fmC2020:is_active() then if fmC2020:get_int(23385) == 4 then fmC2020:set_int(23385, 5) end end end)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local protMenu = OnlMenu:add_submenu("Protections")
...
protMenu:add_toggle("Block SE-Kick", function()
	return sek
end, function()
	sek = not sek
	SeKick(boolsek)
...
protMenu:add_toggle("Block Modified sms", function()
	return boolrm
end, function()
	boolrm = not boolrm
...
protMenu:add_toggle("Block Bounty", function()
	return boolbo
end, function()
	boolbo = not boolbo
	Bounty(boolbo)
...
protMenu:add_toggle("Block Modify Wanted LvL", function()
	return boolclw
end, function()
	boolclw = not boolclw
	ClearWanted(boolclw)
...
protMenu:add_toggle("Block Off-Radar", function()
	return boolotr
end, function()
	boolotr = not boolotr
	OffTheRadar(boolotr)
...
protMenu:add_toggle("Block Destroy Personal Vehicles", function()
	return boolpvd
end, function()
	boolpvd = not boolpvd
...
protMenu:add_toggle("Block Anti-GodMode", function()
	return boolgod
end, function()
	boolgod = not boolgod
	Godmode(boolgod)
...
protMenu:add_toggle("Block Tp To Cayo", function()
	return boolcbt
end, function()
	boolcbt = not boolcbt
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local spoof = OnlMenu:add_submenu("Stat Spoofer")

local function Text(text)
	spoof:add_action(text, function() end)
end

local rp = { 0, 800, 2100, 3800, 6100, 9500, 12500, 16000, 19800, 24000, 28500, 33400, 38700, 44200, 50200, 56400, 63000, 69900, 77100, 84700, 92500, 100700, 109200, 118000, 127100, 136500, 146200,
...
local kills = 1
local deaths = 1
local ply = localplayer:get_player_id() * 888
skidy_1 = 1
removeset1 = 2
removeset2 = 2
removeset3 = 2
...
local function setrank()
	globals.set_int(1853131 + 1 + ply + 205 + 6, rank)
	if boolrp then
		if rank <= 8000 then
			globals.set_int(1853131 + 1 + ply + 205 + 1, rp[rank])
		end
	end
end

local function setbmoney()
	globals.set_int(1853131 + 1 + ply + 205 + 56, bmoney)  
end

local function setmoney()
	globals.set_int(1853131 + 1 + ply + 205 + 3, money)  
end

local function setkills()
	 globals.set_int(1853131 + 1 + ply + 205 + 28, kills)
end

local function setdeaths()
	 globals.set_int(1853131 + 1 + ply + 205 + 29, deaths)
end

local function setkd()
	globals.set_float(1853131 + 1 + ply + 205 + 26, kd)
end

spoof:add_array_item(
    "Spoofear",
    {"Nivel", "Dinero Total","Dinero en mano", "K/D", "Kills", "Muertes"},
    function()
        return skidy_1
    end,
    function(value)
...
spoof:add_int_range("Change Value by", 10, 1, 2147483647, function()
end, function(value)
	steps = value
end)
...
spoof:add_toggle("Spoof", function()
	return boolsr
end, function()
	boolsr = not boolsr
	sad(boolsr)
...
Text("--")
local cus = spoof:add_submenu("Features")
cus:add_toggle("Adapt RP To Rank", function()
	return boolrp 
end, function()
	boolrp = not boolrp
end)
Text("--")
tut = spoof:add_submenu("XxpichoclesxX#0427")  

local function tText(text)
	tut:add_action(text, function() end)
end
tText("Tutorial")
tText("--")
tText("1. Select what u want to Spoof and")
tText("press numpa5 to apply")
tText("2. Select the Value")
tText("press numpa5 to apply")
tText("3. Check the Checkbox")
tText("--")
tText("When u want to change a value! U dont")
tText("need to but the toogle off just do")
tText("step 1 and 2 again")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
vehMenu = mainMenu:add_submenu("Cars")

F1Mod = false
OldF1Hash = 0
vehMenu:add_toggle("F1 Wheels", function()
	return F1Mod
end, function()
	F1Mod = not F1Mod
	if F1Mod then
...
BennyMod = false
OldBennyHash = 0
vehMenu:add_toggle("Benny's Wheels", function()
	return BennyMod
end, function()
...
recMenu:add_action("Im Not Responsible", function() end)
recMenu:add_action("Of Bad Use <3", function() end)
...
recMenu:add_action("Unlock LSC Paints", function()
...
recMenu:add_action("Weapons", function()
...
recMenu:add_action("Unlock Private Libraries", function()
...
ncMenu:add_int_range("Sport Cargo Value", 5000, 5000, 4000000, function() return globals.get_int(286554) end, function(value) globals.set_int(286554, value) end)
ncMenu:add_int_range("S.A Cargo Value", 10000, 27000, 4000000, function() return globals.get_int(286555) end, function(value) globals.set_int(286555, value) end)
ncMenu:add_int_range("Pharmaceutic Value", 10000, 11475, 4000000, function() return globals.get_int(286556) end, function(value) globals.set_int(286556, value) end)
ncMenu:add_int_range("Organic Value", 10000, 2025, 4000000, function() return globals.get_int(286557) end, function(value) globals.set_int(286557, value) end)
ncMenu:add_int_range("CopyRight Value", 10000, 1350, 4000000, function() return globals.get_int(286558) end, function(value) globals.set_int(286558, value) end)
ncMenu:add_int_range("Fake Money Value", 10000, 4725, 4000000, function() return globals.get_int(286559) end, function(value) globals.set_int(286559, value) end)
ncMenu:add_int_range("Some Cargo Value", 10000, 10000, 4000000, function() return globals.get_int(286560) end, function(value) globals.set_int(286560, value) end)
local function tonyC(e) if not localplayer then return end if e then globals.set_float(286669, 0) else globals.set_float(286669, 0.1) end end ncMenu:add_toggle("Remove Tony's Iva", function() return e29 end, function() e29 = not e29 tonyC(e29) end) ncMenu:add_action("-------Tested:solo public; ~Max=4M------------", function() end)
ncMenu:add_int_range("Reset Sales", 1, 0, 1000, function() return stats.get_int(mpx .. "HUB_SALES_COMPLETED") end, function(value) stats.set_int(mpx .. "HUB_SALES_COMPLETED", value) end) ncMenu:add_int_range("Reset Sale", 500000, 0, 30000000, function() return stats.get_int(mpx .. "HUB_EARNINGS") end, function(value) stats.set_int(mpx .. "HUB_EARNINGS", value) globals.set_int(1575015, 1) globals.set_int(1574589, 1) sleep(0.2) globals.set_int(1574589, 0) end)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
mcMenu = dinMenu:add_submenu("MC Club $$$") local function Speed(e) if not localplayer then return end if e then for i = 279591, 279595 do globals.set_int(i, 0) globals.set_int(i, 1) end else globals.set_int(279594, 300000) globals.set_int(279595, 720000) globals.set_int(279593, 3000000) globals.set_int(279592, 1800000) globals.set_int(279591, 360000) end end mcMenu:add_toggle("Speed Up Production", function() return e16 end, function() e16 = not e16 Speed(e16) end)
local function VRC(e) if not localplayer then return end if e then globals.set_int(281143, 1000) else globals.set_int(281143, 1000) end end mcMenu:add_toggle("Remove Suplies Cooldown", function() return e22 end, function() e22 = not e22 VRC(e22) end)
local function MCrr(e) if not localplayer then return end if e then for i = 0, 4 do stats.set_int(mpx.."PAYRESUPPLYTIMER"..i, 1) sleep(0.1) end else for i = 0, 4 do stats.set_int(mpx.."PAYRESUPPLYTIMER"..i, 0) end end end mcMenu:add_toggle("Full Suplys(beta)", function() return e25 end, function() e25 = not e25 MCrr(e25) end)
local function MCgs(e) if not localplayer then return end if e then globals.set_int(280439, 0) else globals.set_int(280439, 40000) end end mcMenu:add_toggle("Remoove Global Sign", function() return e24 end, function() e24 = not e24 MCgs(e24) end)
mcMenu:add_float_range("Sales Multiplicator", 0.5, 1, 1000, function() return globals.get_float(281256) end, function(value) globals.set_float(281256, value) globals.set_float(281257, value) end) mcMenu:add_action(" ~Use this to get~ ", function() end)
mcMenu:add_action(" ~MAX 2.5M~ ", function() end)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
mmVmenu = dinMenu:add_submenu("Vehicle Cargo $$$") local function Max(e) if not localplayer then return end if e then globals.set_int(281602, 155000) globals.set_int(281603, 155000) globals.set_int(281604, 155000) globals.set_float(281606, 0) globals.set_float(281607, 0) else globals.set_int(281602, 40000) globals.set_int(281603, 25000) globals.set_int(281604, 15000) globals.set_float(281606, 0.25) globals.set_float(281607, 0.5) end end mmVmenu:add_toggle("Max All Ranks", function() return e17 end, function() e17 = not e17 Max(e17) end)
...
local function VRC(e) if not localplayer then return end if e then for i = 281601, 281603 do globals.set_int(i, 0) end else globals.set_int(281601, 34000) globals.set_int(281602, 21250) globals.set_int(281603, 12750) end end mmVmenu:add_toggle("Remove Jimmy Cost", function() return e21 end, function() e21 = not e21 VRC(e21) end) mmVmenu:add_action("---", function() end)
mmVmenu:add_int_range("Hight End", 1000, 40000, 4000000, function() return globals.get_int(281602) end, function(value) globals.set_int(281602, value) end)
...
mmVmenu:add_int_range("Bad End", 1000, 15000, 4000000, function() return globals.get_int(281604) end, function(value) globals.set_int(281604, value) end)
...
monMenu:add_action("Insecure", function() end)
monMenu:add_action("Do not put various at same time", function() end)
monMenu:add_action("Wait 2m", function() end)
monMenu:add_action("For the next", function() end)
...
monMenu:add_action("-----Tested:solo public, UNSAFE!!!------------", function() end)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
mmHmenu:add_int_range("Art Cargo", 50000, 10000, 3100000, function() return globals.get_int(284986) end, function(value) globals.set_int(284986, value) end)
mmHmenu:add_int_range("Quimic Cargo", 50000, 10000, 3100000, function() return globals.get_int(284987) end, function(value) globals.set_int(284987, value) end)
mmHmenu:add_int_range("Fake Money Cargo", 50000, 10000, 3100000, function() return globals.get_int(284988) end, function(value) globals.set_int(284988, value) end)
mmHmenu:add_int_range("Jewerly Cargo", 50000, 10000, 3100000, function() return globals.get_int(284989) end, function(value) globals.set_int(284989, value) end)
mmHmenu:add_int_range("Pharmaceutic Cargo", 50000, 10000, 3100000, function() return globals.get_int(284990) end, function(value) globals.set_int(284990, value) end)
