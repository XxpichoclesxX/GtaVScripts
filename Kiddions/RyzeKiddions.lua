...
OnlMenu:add_toggle("Fuera Del Riedar", GetUndeadOffradar, SetUndeadOffradar)
...
spoof:add_int_range("Multiplicar Valor Por", 10, 1, 2147483647, function()
end, function(value)
	steps = value
end)
...
spoof:add_toggle("Spoofear", function()
	return boolsr
end, function()
	boolsr = not boolsr
	sad(boolsr)
...
Text("--")
local cus = spoof:add_submenu("Opsionez")
cus:add_toggle("Adaptar Rp a rango", function()
	return boolrp 
end, function()
	boolrp = not boolrp
end)
...
tText("Tutorial")
tText("--")
tText("1. Selecciona lo ke kieraz spoofear")
tText("dale al 5 en el pad pa aplicar")
tText("2. Selexiona el valor")
tText("dale al 5 en el pad pa aplicar")
tText("3. Dale a la cajita")
tText("--")
tText("Cuando kieras cambiar un valor, no funcara")
tText("solo apagalo y prendelo")
tText("paso 1 y 2 de nuevo")
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
