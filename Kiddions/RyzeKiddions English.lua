...
modelMenu:add_action("Habilities 100%", function)
...
statMenu:add_action("-----------------------------------------", function() end)
statMenu:add_action("Habilities 100%", function() stats.set_int(mpx .. "SCRIPT_INCREASE_DRIV", 100) stats.set_int(mpx .. "SCRIPT_INCREASE_FLY", 100) stats.set_int(mpx .. "SCRIPT_INCREASE_LUNG", 100) stats.set_int(mpx .. "SCRIPT_INCREASE_SHO", 100) stats.set_int(mpx .. "SCRIPT_INCREASE_STAM", 100) stats.set_int(mpx .. "SCRIPT_INCREASE_STL", 100) stats.set_int(mpx .. "SCRIPT_INCREASE_STRN", 100)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local protMenu = OnlMenu:add_submenu("Protection")
...
pro:add_toggle("Block Infinite Loading Screen", function()
	return boolil
end, function()
	boolil = not boolil
	InfiniteLoad(boolil)
...
pro:add_toggle("Block Pasive Mode", function()
	return boolb
end, function()
	boolb = not boolb
	PassiveMode(boolb)
...
pro:add_toggle("Block Modified sms", function()
	return boolrm
end, function()
	boolrm = not boolrm
...
pro:add_toggle("Block Modify Wanted LvL", function()
	return boolclw
end, function()
	boolclw = not boolclw
	ClearWanted(boolclw)
...
pro:add_toggle("Block Off-Radar", function()
	return boolotr
end, function()
	boolotr = not boolotr
	OffTheRadar(boolotr)
...
pro:add_toggle("Block Destroy Personal Vehicles", function()
	return boolpvd
end, function()
	boolpvd = not boolpvd
...
pro:add_toggle("Block Anti-GodMode", function()
	return boolgod
end, function()
	boolgod = not boolgod
	Godmode(boolgod)
...
pro:add_toggle("Block Tp To Cayo", function()
	return boolcbt
end, function()
	boolcbt = not boolcbt
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local vehMenu = mainMenu:add_submenu("Cars")
...
local rec2Menu = recMenu:add_submenu("Bools Unlocks")
...
recMenu:add_action("Block Bunker Research", function()
	for j = 0, 63 do
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local dinMenu = mainMenu:add_submenu("Money $$$")
...
local ccMenu = dinMenu:add_submenu("CEO Crates $$$")
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local ncMenu = dinMenu:add_submenu("Nightclub$$$")
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local monMenu = dinMenu:add_submenu("Money Loop$$$")
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local mmHmenu = dinMenu:add_submenu("Hangar Cargo$$$")
...
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local CREDMenu = mainMenu:add_submenu("Credits:") CREDMenu:add_action("Kiddions ", function() end) CREDMenu:add_action("Pichocles", function() end) CREDMenu:add_action("Pepe ", function() end) CREDMenu:add_action("Sammy ", function() end) CREDMenu:add_action("Vicente ", function() end) CREDMenu:add_action("Ady", function() end) CREDMenu:add_action("En Especial ", function() end) CREDMenu:add_action("Emir <3 ", function() end)
